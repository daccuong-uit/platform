 ...
 */
export declare function isUserCreatedEvent(event: DomainEvent<unknown>): event is UserCreatedEvent;
export declare function isUserAccountStatusUpdatedEvent(event: DomainEvent<unknown>): event is UserAccountStatusUpdatedEvent;
export declare function isPostLikeCreatedEvent(event: DomainEvent<unknown>): event is PostLikeCreatedEvent;
